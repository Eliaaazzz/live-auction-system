...
|---|---|---|---|
| `ROOM_SNAPSHOT` | `status, currentPriceCents, winnerId, endAtMs, seq` | Sent after `ROOM_JOIN` or on gap > 200 reset | Reset seqguard watermark; initialize all room state |
